...
Public Class FormAdmin
    ...
    Private Sub BTAltaVehiculo_Click(sender As Object, e As EventArgs) Handles BTAltaVehiculo.Click
        ...
        persona.AltaVehiculo(CBMarcaVehiculo.Text, TBModeloVehiculo.Text, TBAñoVehiculo.Text, TBMotorVehiculo.Text, TBPrecioVehiculo.Text, CBAsientosVehiculos.Text, CBTransmisionesVehiculos.Text, TBPrecioVehiculo.Text, memorystream.ToArray, CBDisponibleVehiculo.Checked)
        DGVVehiculos.DataSource = persona.SeleccionVehiculo()
    End Sub
    ...
    Private Sub BTraerDatosSolicitud_Click(sender As Object, e As EventArgs) Handles BTraerDatosSolicitud.Click

    End Sub

    Private Sub DGVClienteSolicitud_DoubleClick(sender As Object, e As EventArgs) Handles DGVClienteSolicitud.DoubleClick
