...
Public Class CapaDA
    ...
    Public Sub AltaVehiculo(Marca As String, Modelo As String, Año As Integer, Motor As String, Precio As Integer, Asientos As String, Velocidades As Integer, Peso As Decimal, foto As Array, Disponible As Boolean)
        Dim conexion As New SqlConnection(RetornarCadena)
        Dim comando As New SqlCommand
        comando.Connection = conexion
        ...
        comando.Parameters.Add("@Motor", SqlDbType.VarChar).Value = Motor
        comando.Parameters.Add("@Precio", SqlDbType.Int).Value = Precio
        comando.Parameters.Add("@Asientos", SqlDbType.VarChar).Value = Asientos
...
=======
    Public Function SeleccionarVentasxEmpleado(Idempleado As Integer) As DataTable
        Dim consulta As String = "Select * from VistaVenta where IdEmpleado = '" & Idempleado & "'"
